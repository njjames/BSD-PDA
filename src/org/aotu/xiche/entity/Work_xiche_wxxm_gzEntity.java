 ...
 *
 */
@Table(value="work_xiche_wxxm_gz")
public class Work_xiche_wxxm_gzEntity {
	@Column
	private int reco_no;
	@Column
	...
	public int getWxxm_hyxm() {
		return wxxm_hyxm;
	}
	public void setWxxm_hyxm(int wxxm_hyxm) {
