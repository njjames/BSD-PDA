...
/**
 * 
 * title:Work_pz_sjEntity
 * @Description:<维修数据表>
 * @author Zhang Yalong
 * @date 2017-5-4 下午5:48:24
 * @version: V1.0
 */
@Table(value="work_pz_sj")
public class Work_pz_sjEntity{
	@Column
	private Integer id;
	@Column
	...
	public void setXche_lc(double xche_lc){
	this.xche_lc=xche_lc;
	}
	public double getXche_lc(){
		return xche_lc;
	}
	...
	public void setFlag_NotRemind(boolean Flag_NotRemind){
	this.Flag_NotRemind=Flag_NotRemind;
	}
	public boolean getFlag_NotRemind(){
		return Flag_NotRemind;
	}
