...
import org.nutz.dao.entity.annotation.Table;
   ...
   /**
    * work_baojia_pz 实体类
    * Wed Apr 12 14:43:02 GMT+08:00 2017  Ze Ming
    */ 

@Table("work_baojia_pz")
public class offerEntity{
	...
	public int getList_yjjclc() {
		return List_yjjclc;
	}
	public void setList_yjjclc(int list_yjjclc) {
	...
	public void setList_state(boolean List_state){
	this.List_state=List_state;
	}
	public boolean getList_state(){
		return List_state;
	}
